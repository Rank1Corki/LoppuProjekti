...
public class InventoryUI : MonoBehaviour
{
    ...
    void Update()
    {
        UpdateInventoryUI(player1Inventory, woodQuantityTextPlayer1, cannonballQuantityTextPlayer1, shrapnelballQuantityTextPlayer1);
        UpdateInventoryUI(player2Inventory, woodQuantityTextPlayer2, cannonballQuantityTextPlayer2, shrapnelballQuantityTextPlayer2);
    }

    // Function to update UI text based on the inventory's contents
    private void UpdateInventoryUI(Inventory inventory, TMP_Text woodText, TMP_Text cannonballText, TMP_Text shrapnelballText)
    {
